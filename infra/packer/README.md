...
└── templates/
    ...
    ├── ubuntu-24.04/
        ...
        ├── ubuntu-24.04.pkr.hcl       # Ubuntu 24.04.3 cloud-init template build
...
Ubuntu 24.04 receives a temporary NoCloud seed CD generated by Packer and
...
For Ubuntu 24.04, use its separate example and resolver from that template
directory:

```bash
cp infra/packer/templates/ubuntu-24.04/ubuntu-24.04.pkrvars.example infra/packer/templates/ubuntu-24.04/ubuntu-24.04.pkrvars.hcl
cd infra/packer/templates/ubuntu-24.04
packer init .
eval "$(bash ../../../scripts/resolve-packer-template.sh ubuntu-24.04)"
export PKR_VAR_vm_id PKR_VAR_vm_template_name PKR_VAR_iso_url PKR_VAR_iso_checksum
...
preseed and Ubuntu 24.04 uses Subiquity NoCloud autoinstall. Ubuntu 26.04 is
blocked by LP #2150636 / #2150640 affecting kernel 7.0.0-14; do not run it until
Canonical provides a respun ISO. They are resolved
